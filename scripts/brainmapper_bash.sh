...
echo "  model:           $model"
echo ""
brainmapper -s $cell_file -b $background_file -o $output_dir -v ${VOXEL_SIZE:-5 2 2} --orientation psl  --trained-model $model --atlas $atlas --soma-diameter 20 --log-sigma-size 0.4 --threshold 8.0 --tiled-threshold 8.0 --ball-xy-size 6 --ball-z-size 10 --ball-overlap-fraction 0.6
