...
def distances_between_starters(bcs_boot, starter_df):
    dist2same = []
    sectiondiff = []
    dist2others = []
    for bc in bcs_boot:
        ...
        p, d = compute_pairwise_distances(cells, return_section_info=True)
...
def compute_pairwise_distances(df, return_section_info=False):
